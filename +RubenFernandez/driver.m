...
M_.endo_names(13) = {'logQ'};
M_.endo_names_tex(13) = {'logQ'};
M_.endo_names_long(13) = {'logQ'};
...
M_.param_names(8) = {'ucbar'};
M_.param_names_tex(8) = {'ucbar'};
M_.param_names_long(8) = {'ucbar'};
M_.param_names(9) = {'pdbar'};
M_.param_names_tex(9) = {'pdbar'};
M_.param_names_long(9) = {'pdbar'};
M_.param_names(10) = {'pcbar'};
M_.param_names_tex(10) = {'pcbar'};
M_.param_names_long(10) = {'pcbar'};
M_.param_names(11) = {'rfbar'};
M_.param_names_tex(11) = {'rfbar'};
M_.param_names_long(11) = {'rfbar'};
M_.param_names(12) = {'Qbar'};
M_.param_names_tex(12) = {'Qbar'};
M_.param_names_long(12) = {'Qbar'};
M_.param_names(13) = {'mbar'};
M_.param_names_tex(13) = {'mbar'};
M_.param_names_long(13) = {'mbar'};
...
mu = M_.params(3);
M_.params(7) = 9.800000e-01;
rho = M_.params(7);
M_.params(13) = log(M_.params(1))-M_.params(3)/M_.params(4);
mbar = M_.params(13);
M_.params(9) = log(exp(M_.params(3)+M_.params(13))/(1-exp(M_.params(3)+M_.params(13))));
pdbar = M_.params(9);
M_.params(10) = log(exp(M_.params(3)+M_.params(13))/(1-exp(M_.params(3)+M_.params(13))));
pcbar = M_.params(10);
M_.params(8) = 1/(1-1/M_.params(4))*log((1-M_.params(1))*(1+exp(M_.params(10))));
ucbar = M_.params(8);
M_.params(11) = (-M_.params(13));
rfbar = M_.params(11);
M_.params(12) = exp((1-M_.params(2))*(M_.params(3)+M_.params(8)));
Qbar = M_.params(12);
%
...
oo_.steady_state(12) = M_.params(12);
oo_.steady_state(13) = log(M_.params(12));
oo_.steady_state(5) = M_.params(13);
oo_.steady_state(6) = M_.params(9);
oo_.steady_state(8) = M_.params(11);
oo_.steady_state(9) = 0;
oo_.steady_state(10) = M_.params(11);
